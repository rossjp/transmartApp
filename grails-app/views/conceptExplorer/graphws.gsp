...
conceptName = conceptName.replaceAll(" ", "%20");
...
{
	URL u1 = new URL("http://conceptgen.ncibi.org/ConceptWeb/cws?qt=nodeDirect&conceptId=" + conceptId + "&conceptName=" + conceptName + "&conceptTypeId=" + conceptTypeId + "&elementSize=" + elementSize);
	BufferedReader inp1 = new BufferedReader(new InputStreamReader(u1.openStream()));
	nodes = inp1.readLine();
	
	URL u2 = new URL("http://conceptgen.ncibi.org/ConceptWeb/cws?qt=edgeDirect&conceptId=" + conceptId);
